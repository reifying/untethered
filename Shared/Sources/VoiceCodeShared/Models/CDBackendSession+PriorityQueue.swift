...
extension CDBackendSession {
    ...
    public static func addToPriorityQueue(_ session: CDBackendSession, context: NSManagedObjectContext) {
    ...
    public static func removeFromPriorityQueue(_ session: CDBackendSession, context: NSManagedObjectContext) {
    ...
    public static func changePriority(_ session: CDBackendSession, newPriority: Int32, context: NSManagedObjectContext) {
        guard session.isInPriorityQueue else {
    ...
    public static func reorderSession(_ session: CDBackendSession, between above: CDBackendSession?, and below: CDBackendSession?, context: NSManagedObjectContext) {
        guard session.isInPriorityQueue else {
