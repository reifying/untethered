...
var G__8480 = o;
reagent.impl.template.goog$module$goog$object.set(G__8480,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__8607__delegate = function (args){
...
while (G__8608__i < G__8608__a.length) {G__8608__a[G__8608__i] = arguments[G__8608__i + 0]; ++G__8608__i;}
  args = new cljs.core.IndexedSeq(G__8608__a,0,null);
} 
return G__8607__delegate.call(this,args);};
G__8607.cljs$lang$maxFixedArity = 0;
G__8607.cljs$lang$applyTo = (function (arglist__8609){
var args = cljs.core.seq(arglist__8609);
return G__8607__delegate(args);
});
...
var G__8494 = o;
reagent.impl.template.goog$module$goog$object.set(G__8494,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__8619__i < G__8619__a.length) {G__8619__a[G__8619__i] = arguments[G__8619__i + 0]; ++G__8619__i;}
  args = new cljs.core.IndexedSeq(G__8619__a,0,null);
} 
...
var G__8501 = props;
var G__8501__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8501,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8501);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8501__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8502 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8502,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8502;
}
})(),id_class);
...
var G__8503 = (cljs.core.count(argv) - first_child);
switch (G__8503) {
case (0):
...
var vec__8507 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8507,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8507,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8507,(2),null);
...
var temp__5827__auto___8637 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___8637 == null)){
} else {
var key_8639 = temp__5827__auto___8637;
(jsprops.key = key_8639);
}
...
var temp__5827__auto___8643 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___8643 == null)){
} else {
var key_8645 = temp__5827__auto___8643;
(jsprops.key = key_8645);
}
...
var temp__5827__auto___8653 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___8653 == null)){
} else {
var key_8657 = temp__5827__auto___8653;
(jsprops.key = key_8657);
}
...
var temp__5827__auto___8675 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___8675 == null)){
} else {
var key_8678 = temp__5827__auto___8675;
(jsprops.key = key_8678);
}
...
var temp__5827__auto___8681 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___8681 == null)){
} else {
var key_8682 = temp__5827__auto___8681;
(jsprops.key = key_8682);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8540_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8540_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8542 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8542,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8542,(1),null);
...
var G__8571 = tag;
var G__8571__$1 = (((G__8571 instanceof cljs.core.Keyword))?G__8571.fqn:null);
switch (G__8571__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template8577 = (function (opts,id,fn_to_element,parse_fn,meta8578){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template8577.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8579,meta8578__$1){
var self__ = this;
var _8579__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8577(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8578__$1));
}));

(reagent.impl.template.t_reagent$impl$template8577.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8579){
var self__ = this;
var _8579__$1 = this;
return self__.meta8578;
}));

(reagent.impl.template.t_reagent$impl$template8577.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8577.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8577.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8577.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8577.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8577.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8578","meta8578",1455863818,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8577.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8577.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8577");

(reagent.impl.template.t_reagent$impl$template8577.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template8577");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8577.
 */
reagent.impl.template.__GT_t_reagent$impl$template8577 = (function reagent$impl$template$__GT_t_reagent$impl$template8577(opts,id,fn_to_element,parse_fn,meta8578){
return (new reagent.impl.template.t_reagent$impl$template8577(opts,id,fn_to_element,parse_fn,meta8578));
});
...
return (new reagent.impl.template.t_reagent$impl$template8577(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
