...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9033 = cljs.core.instance_QMARK_;
var expr__9034 = reactive_val;
if(cljs.core.truth_((pred__9033.cljs$core$IFn$_invoke$arity$2 ? pred__9033.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__9034) : pred__9033.call(null,reagent.ratom.RAtom,expr__9034)))){
return "ra";
} else {
if(cljs.core.truth_((pred__9033.cljs$core$IFn$_invoke$arity$2 ? pred__9033.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__9034) : pred__9033.call(null,reagent.ratom.RCursor,expr__9034)))){
return "rc";
} else {
if(cljs.core.truth_((pred__9033.cljs$core$IFn$_invoke$arity$2 ? pred__9033.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__9034) : pred__9033.call(null,reagent.ratom.Reaction,expr__9034)))){
return "rx";
} else {
if(cljs.core.truth_((pred__9033.cljs$core$IFn$_invoke$arity$2 ? pred__9033.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__9034) : pred__9033.call(null,reagent.ratom.Track,expr__9034)))){
return "tr";
} else {
return "other";
}
