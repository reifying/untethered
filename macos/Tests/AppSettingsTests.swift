...
// Unit tests for AppSettings (macOS)
...
final class AppSettingsTests: XCTestCase {
    ...
    // MARK: - Auto-Play Responses Tests

    func testDefaultAutoPlayResponses() {
        // Default should be false (disabled on macOS)
        XCTAssertFalse(settings.autoPlayResponses)
    }
    ...
    func testAutoPlayResponsesPersistence() {
        ...
        // Value should be saved to UserDefaults
        let saved = UserDefaults.standard.bool(forKey: "autoPlayResponses")
        XCTAssertTrue(saved)
    ...
    func testAutoPlayResponsesToggle() {
        // Start with default (false)
        XCTAssertFalse(settings.autoPlayResponses)

        // Toggle to true
        settings.autoPlayResponses = true
        XCTAssertTrue(settings.autoPlayResponses)
