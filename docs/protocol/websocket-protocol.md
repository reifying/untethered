# Voice-Code WebSocket & HTTP Protocol

Reference doc. Not auto-imported into Claude context — open on demand when working on the protocol surface.

For naming/coding conventions (which JSON keys, kebab-vs-snake, UUID lowercasing) see [`STANDARDS.md`](../../STANDARDS.md).
